package org.expressme.examples.typecho.module;
...
import org.expressme.examples.typecho.search.NameConstants;
import org.expressme.examples.typecho.search.SearchFacade;
import org.expressme.examples.typecho.search.SearchableItem;
import org.expressme.examples.typecho.web.interceptor.BindAndValidatorInterceptor;
import org.expressme.examples.typecho.web.interceptor.IdentityInterceptor;
import org.expressme.examples.typecho.web.manager.FetchIdentityImpl;
 ...
 */
public class TypechoModule implements Module, ServletContextAware {
	...
	void configureWeb(Binder binder) {
		...
		WebScanner.scanning(binder, "org.expressme.examples.typecho.web");
	}
}
